...
const SYSTEMS = [
  ...
  // ----------------------------------------------------------------- MARS ----
  {
    ...
    moons: [
      { name: "Phobos", texture: "textures/moons/phobos.jpg", radius: 11.3, distance: 9376, discovered: 1877, by: "Asaph Hall", color: 0x8a7a6d, famous: true,
      ...
      { name: "Deimos", texture: "textures/moons/deimos.jpg", radius: 6.2, distance: 23463, discovered: 1877, by: "Asaph Hall", color: 0x9a8b7c, famous: true,
  ...
  // -------------------------------------------------------------- JUPITER ----
  {
    ...
    moons: [
      ...
      // Galilean
      { name: "Io", texture: "textures/moons/io.jpg", radius: 1821, distance: 421700, discovered: 1610, by: "Galileo Galilei", color: 0xe8d84b, famous: true,
      ...
      { name: "Europa", texture: "textures/moons/europa.jpg", radius: 1560, distance: 671100, discovered: 1610, by: "Galileo Galilei", color: 0xcdb79a, famous: true,
      ...
      { name: "Ganymede", texture: "textures/moons/ganymede.jpg", radius: 2634, distance: 1070400, discovered: 1610, by: "Galileo Galilei", color: 0x9c9284, famous: true,
      ...
      { name: "Callisto", texture: "textures/moons/callisto.jpg", radius: 2410, distance: 1882700, discovered: 1610, by: "Galileo Galilei", color: 0x6b6258, famous: true,
  ...
  // --------------------------------------------------------------- SATURN ----
  {
    ...
    moons: [
      ...
      { name: "Mimas", texture: "textures/moons/mimas.jpg", radius: 198, distance: 185540, discovered: 1789, by: "W. Herschel", color: 0xc8c2b4, famous: true,
      ...
      { name: "Enceladus", texture: "textures/moons/enceladus.jpg", radius: 252, distance: 237950, discovered: 1789, by: "W. Herschel", color: 0xf2f4f5, famous: true,
      ...
      { name: "Tethys", texture: "textures/moons/tethys.jpg", radius: 531, distance: 294660, discovered: 1684, by: "G. Cassini", color: 0xe8e6df, famous: true,
      ...
      { name: "Dione", texture: "textures/moons/dione.jpg", radius: 561, distance: 377400, discovered: 1684, by: "G. Cassini", color: 0xdedad2, famous: true,
      ...
      { name: "Rhea", texture: "textures/moons/rhea.jpg", radius: 764, distance: 527040, discovered: 1672, by: "G. Cassini", color: 0xdcdad3, famous: true,
      ...
      { name: "Iapetus", texture: "textures/moons/iapetus.jpg", radius: 734, distance: 3560820, discovered: 1671, by: "G. Cassini", color: 0x8a7b5c, famous: true,
  ...
  // -------------------------------------------------------------- NEPTUNE ----
  {
    ...
    moons: [
      ...
      { name: "Triton", texture: "textures/moons/triton.jpg", radius: 1353, distance: 354759, discovered: 1846, by: "W. Lassell", color: 0xd6c6b0, famous: true,
